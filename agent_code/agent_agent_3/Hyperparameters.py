...
DECAY = 2600  # How fast the ratio of random actions decays. Set to approx 0.01 N with N being the number of rounds for training

P_ZERO = 0.2  # Starting value of ratio of random actions

FEATURE_DIM = 39  # Size of the feature vector
BATCH_SIZE = 300000  # Batch size for  training
...
FOLDER = "run_6_2021_03_24/"

#Commandline: python main.py play --my-agent Trainer --train 1 --n-rounds 25000 --no-gui                                                                                                                                                                                                                                                                                             
