...
##########################################################################
# Stuff we load
from agent_code.coin_agent_new_features.Experience_Buffer import Experience_Buffer
from agent_code.coin_agent_new_features.Gradient_Boosting_Model import GBM_Model
##############################################################################

##########################################################################
# Our Hyperparameters for the Training
from agent_code.coin_agent_new_features.Hyperparameters import *
##########################################################################
...
def setup_training(self):
    ...
    self.buffer = Experience_Buffer(D=FEATURE_DIM, gamma=GAMMA, N_max=120000)
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    if last_game_state["round"] % TRAIN_FREQ == 0 and self.stat_track["round"][-1] > 500:
